...
var server = http.createServer(function (request, response) {
    ...
    if (path === '/index.html') {
        ...
        let resBody = fs.readFileSync('public/index.html').toString()
        ...
        response.end()
    } else if (path === '/encapsulation-of-ajax.js') {
        response.statusCode = 200
        response.setHeader('Content-type', 'text/javascript;charset=utf-8')
        response.write(fs.readFileSync('public/encapsulation-of-ajax.js'))
        response.end()
    } else {
